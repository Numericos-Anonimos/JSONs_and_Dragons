...
def run_debug():
    ...
    roots = list_files(
        token,
        "name = 'JSONs_and_Dragons' and mimeType = 'application/vnd.google-apps.folder' and trashed = false",
    )
    ...
    for root in roots:
        ...
        bds = list_files(
            token,
            f"name = 'BD' and '{root['id']}' in parents and mimeType = 'application/vnd.google-apps.folder' and trashed = false",
        )
            ...
            for f in files:
                ...
                if f["name"] == "metadata.json":
                    ...
                    if f["mimeType"] == "application/vnd.google-apps.document":
                        print(
                            "           ⚠️ ALERTA: Isto é um Google Doc, não um arquivo JSON puro!"
                        )
